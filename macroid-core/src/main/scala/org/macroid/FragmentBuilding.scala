...
object FragmentBuildingMacros {
  ...
  def fragmentImpl[F: c.WeakTypeTag](c: MacroContext)(ctx: c.Expr[ActivityContext], fragment: c.Expr[Fragment[F]]) = {
    ...
    c.Expr[FragmentBuilder[F]](q"org.macroid.FragmentBuilder(org.macroid.util.Thunk($constructor), new android.os.Bundle)($ctx, $fragment)")
  }
  ...
  def passImpl[F: c.WeakTypeTag](c: MacroContext)(arguments: c.Expr[(String, Any)]*) = {
    ...
    c.Expr[FragmentBuilder[F]](q"org.macroid.FragmentBuilder($constructor, $args + bundle(..$arguments))($ctx, $fragment)")
  }
}
