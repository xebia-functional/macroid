...
object DrawerLayoutTweaks {
  ...
  def dlLayoutGravity(gravity: Int): Tweak[View] = Tweak[View] { view ⇒
    val param = new DrawerLayout.LayoutParams(view.getLayoutParams.width,
  ...
  def dlLockedClosedStart: Tweak[W] =
    Tweak[W](
      _.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED,
                          GravityCompat.START))
  ...
  def dlUnlockedStart: Tweak[W] =
    Tweak[W](
      _.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED, GravityCompat.START))

  def dlUnlockedEnd: Tweak[W] =
    Tweak[W](
      _.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED, GravityCompat.END))
  ...
  def dlLockedOpenStart: Tweak[W] =
    Tweak[W](
      _.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_OPEN,
                          GravityCompat.START))
