...
object FloatingActionButtonTweaks {
  ...
  def fbaColorResource(id: Int, rippleId: Int)(implicit contextWrapper: ContextWrapper) = Tweak[W] {
    view ⇒
  ...
  def fbaColor(color: Int, rippleColor: Int)(implicit contextWrapper: ContextWrapper) = Tweak[W] {
    view ⇒
