...
object ImageViewTweaks {
  ...
  def ivSrc(drawable: Drawable): Tweak[W] =
    Tweak[W](_.setImageDrawable(drawable))
  ...
  def ivScaleType(scaleType: ScaleType): Tweak[W] =
    Tweak[W](_.setScaleType(scaleType))

  def ivCropToPadding(cropToPadding: Boolean): Tweak[W] =
    Tweak[W](_.setCropToPadding(cropToPadding))

  def ivBaseline(baseline: Int): Tweak[W] = Tweak[W](_.setBaseline(baseline))

  def ivBaselineAlignBottom(aligned: Boolean): Tweak[W] =
    Tweak[W](_.setBaselineAlignBottom(aligned))

  def ivImageAlpha(alpha: Int): Tweak[W] = Tweak[W](_.setImageAlpha(alpha))

  def ivAdjustViewBounds(adjustViewBounds: Boolean): Tweak[W] =
    Tweak[W](_.setAdjustViewBounds(adjustViewBounds))
