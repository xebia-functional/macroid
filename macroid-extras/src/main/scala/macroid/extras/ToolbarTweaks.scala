...
object ToolbarTweaks {
  ...
  def tbBackgroundColor(color: Int): Tweak[W] =
    Tweak[Toolbar](_.setBackgroundColor(color))
  ...
  def tbNavigationIcon(drawable: Drawable): Tweak[W] =
    Tweak[W](_.setNavigationIcon(drawable))

  def tbNavigationOnClickListener(click: (View) ⇒ Ui[_]): Tweak[W] =
    Tweak[W](_.setNavigationOnClickListener(new OnClickListener {
