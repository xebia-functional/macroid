...
object ViewGroupTweaks {
  ...
  def vgAddViewByIndex[V <: View](view: V, index: Int): Tweak[ViewGroup] =
    Tweak[ViewGroup](_.addView(view, index))

  def vgAddView[V <: View](view: V): Tweak[W] = Tweak[W](_.addView(view))

  def vgAddView[V <: View](view: V, params: ViewGroup.LayoutParams): Tweak[W] =
    Tweak[W](_.addView(view, params))
  ...
  def vgClipToPadding(clip: Boolean): Tweak[W] =
    Tweak[W](_.setClipToPadding(clip))

  def vgAddViewByIndexParams[V <: View](
      view: V,
      index: Int,
